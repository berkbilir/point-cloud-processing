...
for fname in npy_files:
	...
	o3d.io.write_point_cloud(os.path.join('/Users/berkbilir/Desktop/noiseify_and_partial/noisy_and_partial_meshes', file_name), pcd)


	np.save("/Users/berkbilir/Desktop/noiseify_and_partial/04_pts_noisy_and_partial"+"/"+fname, cloud)
